...
export default function MegaSale() {
  return (
    <div className="w-full mt-4 md:mt-0">
      <div
        className="relative min-h-[550px] sm:min-h-[600px] lg:min-h-[650px] flex items-end justify-center px-6 py-12 md:pb-24 lg:pb-28 text-center bg-cover bg-top"
        style={{
          backgroundImage: `url(${megaSaleBg})`,
        }}
      >
