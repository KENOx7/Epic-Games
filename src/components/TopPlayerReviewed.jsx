...
export default function TopPlayerReviewed() {
  ...
  useEffect(() => {
    axios
      .get("https://epic-games-api-eta.vercel.app/top-player-reviewed/category_summary.json")
      ...
      <div className="overflow-hidden" onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>
        <div className="flex gap-5 transition-transform duration-500 ease-out"
          ...
          {games.map((game) => {
            ...
            return (
              <Link key={game.title} to={`/game/${folderName}?from=top-player-reviewed`} className="block w-[178px] flex-none group">
