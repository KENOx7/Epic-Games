...
export default function TopSellers() {
  ...
  useEffect(() => {
    axios
      .get("https://epic-games-api-eta.vercel.app/top-sellers/category_summary.json")
      ...
      <div className="overflow-hidden" onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>
        <div className="flex gap-5 transition-transform duration-500 ease-out"
          ...
          {games.map((game) => {
            ...
            const imageSrc = `https://epic-games-api-eta.vercel.app/top-sellers/${folderName}/cover.jpg`
            const inWishlist = isInWishlist(game.title)

            return (
              <Link key={game.title} to={`/game/${folderName}?from=top-sellers`} className="block w-[178px] flex-none group">
