...
export default function TopSellers() {
  ...
  useEffect(() => {
    axios.get('https://epic-games-a-pi.vercel.app/top-sellers/category_summary.json')
      ...
      <div className="overflow-hidden">
        <div
          ...
          {games.map((game, index) => {
            ...
            const imageSrc = `https://epic-games-a-pi.vercel.app/top-sellers/${folderName}/cover.jpg`;
            const { discount, oldPrice, newPrice } = game;

            return (
              <Link key={index} to={`/game/${folderName}?from=top-sellers`} className="block flex-shrink-0 w-[178px] group">
